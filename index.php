					...
					<?php for ($i=0;$i<((count($eventlist_upcoming)>3)?3:count($eventlist_upcoming));$i++)    {?>
						...
						<section class="event">
							...
							<article class="event-content">
								<p><?php print $eventlist_upcoming[$i]["event_description"][0] ?> <a href="event-detail" onclick="readMoreUp(<?php echo $eventlist_upcoming[$i]["pid"][0] ?>); return false;">[Read More]</a></p>
							</article>
						</section>
					<?php }
					?>
